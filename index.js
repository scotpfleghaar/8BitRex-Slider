...
<script>
    ...
    (function (factory) {
        ...
        IonRangeSlider.prototype = {
             ...
             */
            append: function () {
                var container_html = '<span class="irs js-irs-' + this.plugin_count + ' ' + this.options
                    .extra_classes + '"></span>';
            ...
            bindEvents: function () {
                ...
                if (this.options.type === "single") {
                    this.$cache.single.on("touchstart.irs_" + this.plugin_count, this.pointerDown.bind(
                        this, "single"));
                    this.$cache.s_single.on("touchstart.irs_" + this.plugin_count, this.pointerDown.bind(
                        this, "single"));
                    ...
                    this.$cache.edge.on("mousedown.irs_" + this.plugin_count, this.pointerClick.bind(
                        this, "click"));
                    this.$cache.shad_single.on("mousedown.irs_" + this.plugin_count, this.pointerClick.bind(
                        this, "click"));
                } else {
                    this.$cache.single.on("touchstart.irs_" + this.plugin_count, this.pointerDown.bind(
                        this, null));
                    ...
                    this.$cache.s_to.on("touchstart.irs_" + this.plugin_count, this.pointerDown.bind(
                        this, "to"));
                    this.$cache.shad_from.on("touchstart.irs_" + this.plugin_count, this.pointerClick.bind(
                        this, "click"));
                    this.$cache.shad_to.on("touchstart.irs_" + this.plugin_count, this.pointerClick.bind(
                        this, "click"));
                    ...
                    this.$cache.s_to.on("mousedown.irs_" + this.plugin_count, this.pointerDown.bind(
                        this, "to"));
                    this.$cache.shad_from.on("mousedown.irs_" + this.plugin_count, this.pointerClick.bind(
                        this, "click"));
            ...
            calc: function (update) {
                ...
                switch (this.target) {
                    case "base":
                        ...
                        this.coords.p_single_real = this.checkDiapason(this.coords.p_single_real, this.options
                            .from_min, this.options.from_max);
                        this.coords.p_from_real = this.checkDiapason(this.coords.p_from_real, this.options
                            .from_min, this.options.from_max);
                    ...
                    case "from":
                        ...
                        this.coords.p_from_real = this.checkDiapason(this.coords.p_from_real, this.options
                            .from_min, this.options.from_max);
                        this.coords.p_from_real = this.checkMinInterval(this.coords.p_from_real, this.coords
                            .p_to_real, "from");
                        this.coords.p_from_real = this.checkMaxInterval(this.coords.p_from_real, this.coords
                            .p_to_real, "from");
            ...
            chooseHandle: function (real_x) {
                if (this.options.type === "single") {
                    ...
                    var m_point = this.coords.p_from_real + ((this.coords.p_to_real - this.coords.p_from_real) /
                        2);
                    if (real_x >= m_point) {
            ...
            calcLabels: function () {
                ...
                if (this.options.type === "single") {
                    ...
                    this.labels.p_to_left = this.coords.p_to_fake + (this.coords.p_handle / 2) - (this.labels
                        .p_to_fake / 2);
            ...
            drawLabels: function () {
                ...
                if (this.options.type === "single") {
                    ...
                    if (this.labels.p_single_left + this.labels.p_single_fake > 100 - this.labels.p_max -
                        1) {
                    ...
                    if (values_num) {
                        ...
                        if (this.options.decorate_both) {
                            ...
                            text_single = this.decorate(from_pretty + this.options.values_separator +
                                to_pretty, this.result.to);
                        }
            ...
            calcGridLabels: function () {
                ...
                if (this.options.force_edges) {
                    ...
                    if (finish[num - 1] > 100 + this.coords.grid_gap) {
                        ...
                        this.coords.big_x[num - 1] = this.toFixed(this.coords.big_p[num - 1] - this.coords
                            .grid_gap);
                    }
                }
    ...
    // $('#et_pb_contact_budget-range-slider_1')

    $(document).ready(function () {
        setInputUp();
        console.log('[setInputUp]');
